...
import edu.platform.modules.quiz.dto.request.QuizSubmissionRequest;
import edu.platform.modules.quiz.dto.request.StudentAnswerRequest;
...
import edu.platform.common.exception.BusinessException;
import edu.platform.common.exception.ResourceNotFoundException;
import edu.platform.modules.quiz.mapper.QuizAttemptMapper;
...
public class QuizAttemptService {
    ...
    private final VisitTrackingFacade visitTrackingFacade;
    ...
    public QuizAttemptResponse startQuizAttempt(Long quizId, Long studentId) {
        ...
        User student = userAccessFacade.getUserById(studentId);
        ...
        visitTrackingFacade.recordQuizStart(studentId, quiz.getCourse().getId(), quizId, null);
    ...
    public QuizAttemptResponse submitQuizAttempt(QuizSubmissionRequest request, Long studentId) {
        ...
        visitTrackingFacade.recordQuizCompletion(
                studentId,
