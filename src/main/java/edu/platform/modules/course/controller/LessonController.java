package edu.platform.modules.course.controller;
...
import edu.platform.modules.course.service.LessonService;
...
public class LessonController {
    ...
    public ResponseEntity<LessonResponse> createLesson(@Valid @RequestBody LessonRequest request) {
        ...
        Long teacherId = userAccessFacade.getUserByEmail(email).getId();
    ...
    private void recordLessonView(LessonResponse lesson, HttpServletRequest request) {
        ...
        try {
            ...
            visitTrackingFacade.recordLessonView(userId, lesson.getCourseId(), lesson.getId(), request);
        } catch (Exception ex) {
