package edu.platform.modules.media.service;
...
import edu.platform.modules.media.repository.MediaAssetRepository;
import edu.platform.modules.media.storage.FileStorage;
import edu.platform.modules.media.storage.StoredFileInfo;
...
public class MediaAssetService {
    ...
    private MediaAssetResponse saveMediaAssetMetadata(StoredFileInfo storedFileInfo, Long ownerId) {
        User owner = userAccessFacade.getUserById(ownerId);
